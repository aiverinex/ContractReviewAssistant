...
class PDFReportGenerator:
    ...
    def _create_title_page(self, results: Dict[Any, Any]) -> list:
        ...
        # Footer
        story.append(Spacer(1, 2*inch))
        story.append(Paragraph("Generated by Contract Reviewer Crew", self.styles['Normal']))
        story.append(Paragraph("AI-Powered Legal Analysis System", self.styles['Normal']))
